...
/// <summary>Represents a square, which is a rectangle with equal sides.</summary>
public class Square : Rectangle
{
    ...
    public int Size
    {
        ...
        set
        {
            ...
            size = value;
            Width = value;   // uses inherited public property (not private field)
            Height = value;  // uses inherited public property
        }
    }
}